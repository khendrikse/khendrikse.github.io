        ...
        <div className={styles.about}>
          ...
          <p>
            <strong>
              ...
              free time I expand my knowledge, tinker on projects in software
              and sometimes hardware and enjoy myself with friends, games and
              plants 🌱.
            </strong>
          </p>
          <h3>Tech</h3>
          <p>
            I use JavaScript and ReactJS on a day-to-day basis. Lately I have
            been diving into the developer experience by learning more about
            Continuous Integration and Continuous Deployment. I really like
            finding ways to increase productivity while creating better quality
            code.
          </p>
          ...
          <p>
            ...
            motivated me to contribute to the developer community. It's why I
            try to be involved in helping out with RailsGirls NL and why I am a
            front-end guild leader at YoungCapital. It brings me great joy to
            help unite fellow developers.
          </p>
        </div>
      </div>
    </Layout>
